...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const mockScores = [
    { submission_code: 'ID-CAT1-001', country: 'ID', category: 'CAT1', judge_user_id: 'Quang Long Tran', score_1: 9, score_2: 8, score_3: 8, score_4: 9, weighted_total: 8.6, comments: 'Excellent literacy program with strong, measurable impact.' },
    ...
    { submission_code: 'PH-CAT1-003', country: 'PH', category: 'CAT1', judge_user_id: 'Dr. Kenny James Merin', score_1: 8, score_2: 7, score_3: 8, score_4: 9, weighted_total: 8.0, comments: 'Strong literacy impact with clear before/after evidence.' },
    ...
    { submission_code: 'VN-CAT4-005', country: 'VN', category: 'CAT4', judge_user_id: 'Prof. Dr. Nguyen Tuan Dung', score_1: 9, score_2: 8, score_3: 9, score_4: 9, weighted_total: 8.65, comments: 'Highly creative, authentic storytelling with strong pharmacy advocacy.' },
